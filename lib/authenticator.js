...
var sessionmanager_1 = __importDefault(require("./sessionmanager"));
var connect_1 = __importDefault(require("./framework/connect"));
/**
 * `Authenticator` class.
 *
 * @api public
...
var Authenticator = /** @class */ (function () {
    ...
    Authenticator.prototype.init = function () {
        ...
        // FIXIT
        (0, connect_1.default)());
        this.use(new session_1.default({ key: this._key }, this.deserializeUser.bind(this)));
    ...
    Authenticator.prototype.authorize = function (strategy, options, callback) {
        ...
        var authorize = this._framework.authorize || this._framework.authenticate;
  ...
  */
    ...
    Authenticator.prototype.deserializeUser = function (fn, req, done) {
        ...
        (function pass(i, err, user) {
            ...
            var layer = stack[i];
            if (!layer) {
                return (done && done(new Error('Failed to deserialize user out of session')));
            }
